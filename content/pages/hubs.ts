...
export const hubsPageContent: HubsPageContent = {
  ...
  model: {
    ...
    stages: [
      { title: "Product", description: "Learners successfully move through an integrated digital and practical learning journey.", icon: "platform" },
      { title: "Learning", description: "The programme develops measurable knowledge and practical competency, with learning outcomes that can evolve and scale.", icon: "learn" },
